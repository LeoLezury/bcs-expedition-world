...
@OnlyIn(Dist.CLIENT)
public class InnerColdproofArmorModel<T extends LivingEntity> extends HumanoidModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ExpeditionWorld.id("coldproof_armor"), "inner");

	public InnerColdproofArmorModel(ModelPart root) {
		super(root);
	}
