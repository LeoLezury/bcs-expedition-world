...
public class EWBlockLootSubProvider extends BlockLootSubProvider {
	public EWBlockLootSubProvider(HolderLookup.Provider registries) {
	...
	protected Iterable<Block> getKnownBlocks() {
		return BuiltInRegistries.BLOCK.stream().filter(block -> BuiltInRegistries.BLOCK.getKey(block).getNamespace().equals(ExpeditionWorld.ID)).collect(Collectors.toList());
	}
}
